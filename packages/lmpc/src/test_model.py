...
class TheController(DTROS):
    ...
    def callback(self, ros_data):
        ...
        y = ros_data.y
        t = ros_data.t
        v = (0.1*MAX_SPEED + 1*MAX_SPEED)/2
        w = (0.1*MAX_SPEED - 1*MAX_SPEED)/0.1
    ...
    def control(self, _):
        ...
        model_x, model_y, model_t, model_v, model_w = self.F([self.model_x, self.model_y, self.model_t, self.model_v, self.model_w], [0.1*MAX_SPEED, 1*MAX_SPEED]).toarray()
        ...
        msg.vel_left = 0.1*MAX_SPEED
        msg.vel_right = 1*MAX_SPEED
    ...
    def on_shutdown(self):
        ...
        print(f"Model positions: {self.model_positions}")
